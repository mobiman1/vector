...
- This section feeds directly into /vector:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /vector:plan-phase --gaps with root causes
...
**Creation:** When /vector:verify-work starts new session
