...
│   └── vector/           # Vector-specific commands
...
**New Slash Command:**
- Primary code: `commands/vector/{command-name}.md`
...
**New Workflow:**
- Implementation: `core/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/core/workflows/{name}.md`
