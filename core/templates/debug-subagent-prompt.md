...
Template for spawning vector-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="vector-debugger", description="Debug UAT-001")
```
