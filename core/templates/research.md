...
**CRITICAL:** If CONTEXT.md exists from /vector:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches Vector templates)
