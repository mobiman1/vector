<purpose>
Retroactive 6-pillar visual audit of implemented frontend code. Standalone command that works on any project — Vector-managed or not. Produces scored UI-REVIEW.md with actionable findings.
</purpose>
...
```bash
UI_AUDITOR_MODEL=$(node "$HOME/.claude/core/bin/vector-tools.cjs" resolve-model vector-ui-auditor --raw)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Vector ► UI AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**If `SUMMARY_FILES` empty:** Exit — "Phase {N} not executed. Run /vector:execute-phase {N} first."
...
```markdown
Read ~/.claude/agents/vector-ui-auditor.md for instructions.
...
Task(
  ...
  subagent_type="vector-ui-auditor",
...
- `/vector:verify-work {N}` — UAT testing
- `/vector:plan-phase {N+1}` — plan next phase
...
```bash
node "$HOME/.claude/core/bin/vector-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
...
- [ ] vector-ui-auditor spawned with correct context
