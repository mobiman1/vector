<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates vector-ui-researcher and vector-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
```bash
UI_RESEARCHER_MODEL=$(node "$HOME/.claude/core/bin/vector-tools.cjs" resolve-model vector-ui-researcher --raw)
UI_CHECKER_MODEL=$(node "$HOME/.claude/core/bin/vector-tools.cjs" resolve-model vector-ui-checker --raw)
```

Check config:

```bash
UI_ENABLED=$(node "$HOME/.claude/core/bin/vector-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
```

**If `UI_ENABLED` is `false`:**
```
UI phase is disabled in config. Enable via /vector:settings.
```
Exit workflow.
...
Recommended: run /vector:discuss-phase {N} first to capture design preferences.
...
## 5. Spawn vector-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Vector ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/vector-ui-researcher.md for instructions.
...
Task(
  ...
  subagent_type="vector-ui-researcher",
...
## 7. Spawn vector-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Vector ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/vector-ui-checker.md for instructions.
...
Task(
  ...
  subagent_type="vector-ui-checker",
...
- Re-spawn vector-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /vector:ui-phase
...
```bash
node "$HOME/.claude/core/bin/vector-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
...
- [ ] vector-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] vector-ui-checker spawned with UI-SPEC.md
