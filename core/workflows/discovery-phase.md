...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /vector:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/core/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/core/templates/discovery.md
...
Use ~/.claude/core/templates/discovery.md.
...
1. Discuss phase context (/vector:discuss-phase [current-phase])
2. Create phase plan (/vector:plan-phase [current-phase])
