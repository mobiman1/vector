---
name: vector-phase-researcher
description: Researches how to implement a phase before planning. Produces RESEARCH.md consumed by vector-planner. Spawned by /vector:plan-phase orchestrator.
...
- **Phase gate:** Full suite green before `/vector:verify-work`
