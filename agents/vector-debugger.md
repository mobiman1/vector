---
name: vector-debugger
description: Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by /vector:debug orchestrator.
...
Resolved debug sessions. Used by `vector-debugger` to surface known-pattern hypotheses at the start of new investigations.
