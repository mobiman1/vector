---
name: vector-ui-auditor
description: Retroactive 6-pillar visual audit of implemented frontend code. Produces scored UI-REVIEW.md. Spawned by /vector:ui-review orchestrator.
...
<upstream_input>
**UI-SPEC.md** (if exists) — Design contract from `/vector:ui-phase`
