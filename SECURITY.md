...
Instead, please report them via email to: **security@prolifix.com** (or DM @mobiman on Discord/Twitter if email bounces)
...
Security issues in the Vector codebase that could:
