...
describe('init commands', () => {
  ...
  test('init execute-phase returns file paths', () => {
    ...
    const result = runVectorTools('init execute-phase 03', tmpDir);
  ...
  test('init plan-phase returns file paths', () => {
    ...
    const result = runVectorTools('init plan-phase 03', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init progress returns file paths', () => {
    const result = runVectorTools('init progress', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init phase-op returns core and optional phase file paths', () => {
    ...
    const result = runVectorTools('init phase-op 03', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init plan-phase extracts phase_req_ids from ROADMAP', () => {
    ...
    const result = runVectorTools('init plan-phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init execute-phase extracts phase_req_ids from ROADMAP', () => {
    ...
    const result = runVectorTools('init execute-phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitTodos', () => {
  ...
  test('empty pending dir returns zero count', () => {
    ...
    const result = runVectorTools('init todos', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('multiple todos with fields are read correctly', () => {
    ...
    const task1 = output.todos.find((t: any) => t.file === 'task-1.md');
  ...
  test('area filter returns only matching todos', () => {
    ...
    const result = runVectorTools('init todos backend', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter miss returns zero count', () => {
    ...
    const result = runVectorTools('init todos nonexistent', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitMilestoneOp', () => {
  ...
  test('no phase directories returns zero counts', () => {
    const result = runVectorTools('init milestone-op', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitPhaseOp fallback', () => {
  ...
  test('normal path with existing directory', () => {
    ...
    const result = runVectorTools('init phase-op 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fallback to ROADMAP when no directory exists', () => {
    ...
    const result = runVectorTools('init phase-op 5', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runVectorTools('init phase-op 2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('neither directory nor roadmap entry returns not found', () => {
    ...
    const result = runVectorTools('init phase-op 99', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitProgress', () => {
  ...
  test('multiple phases with mixed statuses', () => {
    ...
    const p1 = output.phases.find((p: any) => p.number === '01');
...
describe('cmdInitQuick', () => {
  ...
  test('with description generates slug and task_dir with YYMMDD-xxx format', () => {
    const result = runVectorTools('init quick "Fix login bug"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('without description returns null slug and task_dir', () => {
    const result = runVectorTools('init quick', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('two rapid calls produce different quick_ids (no collision within 2s window)', () => {
    ...
    const r1 = runVectorTools('init quick "Task one"', tmpDir);
    const r2 = runVectorTools('init quick "Task two"', tmpDir);
  ...
  test('long description truncates slug to 40 chars', () => {
    const result = runVectorTools('init quick "This is a very long description that should get truncated to forty characters maximum"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitMapCodebase', () => {
  ...
  test('no codebase dir returns empty', () => {
    const result = runVectorTools('init map-codebase', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitNewProject', () => {
  ...
  test('greenfield project with no code', () => {
    const result = runVectorTools('init new-project', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitNewMilestone', () => {
  ...
  test('returns expected fields', () => {
    const result = runVectorTools('init new-milestone', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('file existence flags reflect actual state', () => {
    ...
    const result1 = runVectorTools('init new-milestone', tmpDir);
    ...
    const result2 = runVectorTools('init new-milestone', tmpDir);
