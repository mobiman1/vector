...
describe('dispatcher error paths', () => {
  ...
  test('no-command invocation prints usage and exits non-zero', () => {
    const result = runVectorTools('', tmpDir);
  ...
  test('unknown command produces clear error and exits non-zero', () => {
    const result = runVectorTools('nonexistent-cmd', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('--cwd= form overrides working directory', () => {
    ...
    const result = runVectorTools(`--cwd=${tmpDir} state load`, process.cwd());
  ...
  test('--cwd= with empty value produces error', () => {
    const result = runVectorTools('--cwd= state load', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('--cwd with invalid path produces error', () => {
    const result = runVectorTools('--cwd /nonexistent/path/xyz state load', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('template unknown subcommand errors', () => {
    const result = runVectorTools('template bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('frontmatter unknown subcommand errors', () => {
    const result = runVectorTools('frontmatter bogus file.md', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('verify unknown subcommand errors', () => {
    const result = runVectorTools('verify bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('phases unknown subcommand errors', () => {
    const result = runVectorTools('phases bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('roadmap unknown subcommand errors', () => {
    const result = runVectorTools('roadmap bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('requirements unknown subcommand errors', () => {
    const result = runVectorTools('requirements bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('phase unknown subcommand errors', () => {
    const result = runVectorTools('phase bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('milestone unknown subcommand errors', () => {
    const result = runVectorTools('milestone bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('validate unknown subcommand errors', () => {
    const result = runVectorTools('validate bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('todo unknown subcommand errors', () => {
    const result = runVectorTools('todo bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
  ...
  test('init unknown workflow errors', () => {
    const result = runVectorTools('init bogus', tmpDir);
    assert.strictEqual(result.success, false, 'Should exit non-zero');
...
describe('dispatcher routing branches', () => {
  ...
  test('find-phase locates phase directory by number', () => {
    ...
    const result = runVectorTools('find-phase 01', tmpDir);
  ...
  test('init resume returns valid JSON', () => {
    ...
    const result = runVectorTools('init resume', tmpDir);
  ...
  test('init verify-work returns valid JSON', () => {
    ...
    const result = runVectorTools('init verify-work 01', tmpDir);
  ...
  test('roadmap update-plan-progress updates phase progress', () => {
    ...
    const result = runVectorTools('roadmap update-plan-progress 1', tmpDir);
  ...
  test('state with no subcommand calls cmdStateLoad', () => {
    ...
    const result = runVectorTools('state', tmpDir);
