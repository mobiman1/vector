...
`
    ...
    const result = runVectorTools('roadmap get-phase 1', tmpDir);
...
`
    ...
    const result = runVectorTools('roadmap get-phase 5', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error!}`);
...
`
    ...
    const result = runVectorTools('roadmap get-phase 2.1', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error!}`);
...
`
    ...
    const result1 = runVectorTools('roadmap get-phase 1', tmpDir);
    ...
    const result2 = runVectorTools('roadmap get-phase 2', tmpDir);
...
describe('roadmap analyze command', () => {
  ...
  test('missing ROADMAP.md returns error', () => {
    const result = runVectorTools('roadmap analyze', tmpDir);
...
describe('roadmap update-plan-progress command', () => {
  ...
  test('missing phase number returns error', () => {
    const result = runVectorTools('roadmap update-plan-progress', tmpDir);
...
`
    ...
    const result = runVectorTools('roadmap update-plan-progress 99', tmpDir);
